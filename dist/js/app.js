(() => {
    ...
    likeBtn.forEach((btn => {
        btn.addEventListener("click", (({target}) => {
            if (target.classList.contains("card__favorite-button")) btn.classList.toggle("red");
            if (target.classList.contains("card__favorite-button--catalog")) btn.classList.toggle("green");
        }));
    }));
